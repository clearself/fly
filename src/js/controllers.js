...
.controller('indexPageCtr',function($scope){
	$scope.data = [
				{"title":"windows server 2008R2 x64服务器 搭建PHP环境","description":"windows server 2008R2 x64位服务器上搭建PHP环境,1、安装IIS；2、安装V11；3、安装CGI；4、安装php；5、配置php.ini文件。","dateline":"2017-03-02"},
